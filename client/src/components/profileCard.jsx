    ...
    return (
        <div className="profmaincont">
            ...
            <div className="profileCard">
                ...
                {isEditing ? (
                    <div>
                    <textarea maxLength={120} className='protextarea' placeholder='Add a new description' value={description} onChange={handleDescriptionChange} />
                    <p className="charrempro">{120 - description.length} characters remaining</p>
                    <button className='profsavebutton' onClick={handleSave}>Save</button>
                </div>
            ) : (
                <div>
                    <button className="editbuttonpro" onClick={handleEdit}>About{edit}</button>
